...
import os
#Configuração necessária para o heroku reconhecer o BD
...
SECRET_KEY = '_fp4t$^@zx#$)lwe0=71)+1=2_sizxhota%2nsy&g+s62^!479'
...
#Configuração para Email
#EMAIL_BACKEND É PARA TESTES
